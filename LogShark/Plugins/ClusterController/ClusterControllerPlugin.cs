...
namespace LogShark.Plugins.ClusterController
{
    public class ClusterControllerPlugin : IPlugin
    {
        ...
        private static readonly ISet<DataSetInfo> _outputInfo = new HashSet<DataSetInfo>
            { _errorDSI, _postgresActionDSI, _diskIOSampleDSI, _zkErrorDSI, _zkFsyncLatencyDSI, };
    }
}