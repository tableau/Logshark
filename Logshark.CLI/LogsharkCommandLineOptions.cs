...
namespace Logshark.CLI
{
    ...
    public class LogsharkCommandLineOptions
    {
        ...
        [Option("dbname", DefaultValue = "", HelpText = "Sets a custom name for the database instance where plugin data will be stored.  Only relevant for database persistence plugins.  Default behavior is to generate a new database for each run.  If this argument is specified and the given database name already exists, the data generated by this run will be appended to it.")]
