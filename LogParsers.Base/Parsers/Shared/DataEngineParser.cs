...
namespace LogParsers.Base.Parsers.Shared
{
    ...
    {
        private static readonly string collectionName = SharedParserConstants.DataengineCollectionName;
        ...
        public DataEngineParser(LogFileContext fileContext) : base(fileContext)
        {
        }
    }
}