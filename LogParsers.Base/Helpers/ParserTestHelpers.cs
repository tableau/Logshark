...
namespace LogParsers.Base.Helpers
{
    ...
    public class ParserTestHelpers
    {
        ...
        {
            return Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..\..\..\_TestData");
        }

        /// <summary>
        /// Retrieves the path to a test file in the SampleLogs directory.
        /// </summary>
        public static string GetSampleLog(string file)
        {
            return Path.Combine(GetTestDataPath(), "SampleLogs", file);
        }
    }
}