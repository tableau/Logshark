...
{
    /// <summary>
    /// Parses VizqlServer Java logs to JSON.
    /// </summary>
    public sealed class VizqlServerJavaParser : AbstractMultiLineRegexParser, IParser
    {
        private static readonly string collectionName = ParserConstants.VizqlServerJavaCollectionName;
        private static readonly IList<string> indexNames = new List<string> { "sev", "sess", "req" };
        ...
        public VizqlServerJavaParser() { }
        public VizqlServerJavaParser(LogFileContext fileContext) : base(fileContext) { }
    }
}
