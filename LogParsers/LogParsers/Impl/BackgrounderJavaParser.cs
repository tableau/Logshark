...
namespace LogParsers
{
    ...
    public sealed class BackgrounderJavaParser : AbstractMultiLineRegexParser, IParser
    {
        ...
        private static readonly IList<string> indexNames = new List<string> { "class", "file", "req", "sess", "sev", "ts", "worker" };
        ...
        public BackgrounderJavaParser(LogFileContext fileContext) : base(fileContext) { }
    }
}
