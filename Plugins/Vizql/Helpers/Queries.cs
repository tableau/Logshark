...
namespace Logshark.Plugins.Vizql.Helpers
{
    public class Queries
    {
        ...
        public static VizqlDesktopSession GetDesktopSession(string file, int pid, IMongoCollection<BsonDocument> collection)
        {
            ...
            return new VizqlDesktopSession(document);
        }
        ...
        public static VizqlServerSession GetServerSession(string sessionId, IMongoCollection<BsonDocument> collection)
        {
            ...
            return new VizqlServerSession(firstEvent, lastEvent, GetWorkbookForSession(sessionId, collection), processName, GetBootstrapRequestIdForSession(sessionId, collection));
        }
        ...
        public static string GetWorkbookForSession(string sessionId, IMongoCollection<BsonDocument> collection)
        {
            try
            {
                ...
                return values.GetString("workbook");
            }
            catch
            {
                return null;
