namespace Logshark.PluginLib
{
    public static class PluginLibConstants
    {
        ...
        // Default pool size when spinning up multithreaded persisters.
        public const int DEFAULT_PERSISTER_POOL_SIZE = 10;

        // Default batch size when spinning up batch-oriented persisters.
        ...
        public const string DEFAULT_PERSISTER_STATUS_WRITER_PROGRESS_MESSAGE = "{ItemsPersisted} {PersistedType} records have been persisted.";

        public const string DEFAULT_TASK_STATUS_WRITER_PROGRESS_MESSAGE = "{TasksCompleted} {TaskType} tasks have been completed.";

        public const string DEFAULT_PERSISTER_STATUS_WRITER_PROGRESS_MESSAGE_WITH_TOTAL = "{ItemsPersisted}/{ItemsExpected} {PersistedType} records have been persisted. [{PercentComplete}]";
