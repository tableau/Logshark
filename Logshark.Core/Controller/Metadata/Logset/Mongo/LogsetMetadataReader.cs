...
namespace Logshark.Core.Controller.Metadata.Logset.Mongo
{
    ...
    internal class LogsetMetadataReader
    {
        ...
        public LogsetMetadataReader(LogsharkRequest logsharkRequest)
        {
            ...
            MetadataCollection = mongoDatabase.GetCollection<LogsetMetadata>(CoreConstants.MONGO_METADATA_COLLECTION_NAME);
        ...
        public static void SetLogsetType(LogsharkRequest request)
        {
            ...
            request.RunContext.LogsetType = metadataReader.GetLogsetType();
        }
