...
{
    /// <summary>
    /// Parses HTTPD configuration logs to JSON.
    /// </summary>
    public sealed class HttpdConfigurationParser : AbstractMultiLineRegexParser, IParser
    {
        private static readonly string collectionName = ParserConstants.HttpdConfigurationCollectionName;
        ...
        public HttpdConfigurationParser()
        {
        }

        public HttpdConfigurationParser(LogFileContext fileContext)
            : base(fileContext)
        {
        }
    }
