...
{
    /// <summary>
    /// Parses Service Control logs to JSON.
    /// </summary>
    public sealed class ServiceControlParser : AbstractMultiLineRegexParser, IParser
    {
        private static readonly string collectionName = ParserConstants.ServiceControlCollectionName;
        ...
        public ServiceControlParser()
        {
        }

        public ServiceControlParser(LogFileContext fileContext)
            : base(fileContext)
        {
        }
    }
