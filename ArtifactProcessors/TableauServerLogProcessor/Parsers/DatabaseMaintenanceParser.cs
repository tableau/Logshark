...
{
    /// <summary>
    /// Parses Database Maintenance logs to JSON.
    /// </summary>
    public sealed class DatabaseMaintenanceParser : AbstractMultiLineRegexParser, IParser
    {
        private static readonly string collectionName = ParserConstants.DatabaseMaintenanceCollectionName;
        ...
        public DatabaseMaintenanceParser()
        {
        }

        public DatabaseMaintenanceParser(LogFileContext fileContext)
            : base(fileContext)
        {
        }
    }
