...
{
    /// <summary>
    /// Parses Tabadmin Agent logs to JSON.
    /// </summary>
    public sealed class TabAdminAgentParser : AbstractMultiLineRegexParser, IParser
    {
        private static readonly string collectionName = ParserConstants.TabAdminAgentCollectionName;
        ...
        public TabAdminAgentParser()
        {
        }

        public TabAdminAgentParser(LogFileContext fileContext)
            : base(fileContext)
        {
        }
    }
