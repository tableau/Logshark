...
{
    /// <summary>
    /// Parses VizPortal Java logs to JSON.
    /// </summary>
    public sealed class VizportalJavaParser : AbstractMultiLineRegexParser, IParser
    {
        private static readonly string collectionName = ParserConstants.VizportalJavaCollectionName;
        private static readonly IList<string> indexNames = new List<string> { "file", "req", "sess", "sev" };
        ...
        public VizportalJavaParser()
        {
        }

        public VizportalJavaParser(LogFileContext fileContext)
            : base(fileContext)
        {
        }
    }
