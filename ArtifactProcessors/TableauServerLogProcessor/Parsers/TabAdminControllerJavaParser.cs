...
{
    /// <summary>
    /// Parses Tabadmin Controller Java logs to JSON.
    /// </summary>
    public sealed class TabAdminControllerJavaParser : AbstractMultiLineRegexParser, IParser
    {
        private static readonly string collectionName = ParserConstants.TabAdminControllerJavaCollectionName;
        ...
        public TabAdminControllerJavaParser()
        {
        }

        public TabAdminControllerJavaParser(LogFileContext fileContext)
            : base(fileContext)
        {
        }
    }
