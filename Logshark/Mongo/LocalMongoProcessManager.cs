...
namespace Logshark.Mongo
{
    ...
    public sealed class LocalMongoProcessManager
    {
        ...
        public LocalMongoProcessManager(int portToStartOn = LogsharkConstants.MONGO_LOCAL_PORT_DEFAULT)
        {
            port = portToStartOn;
        }
        ...
        public Process StartMongoProcess()
        {
            ...
            try
            {
                ...
                if (!IsMongoRunning())
                {
                    throw new InitializationException("Issued mongod process start, but process is not running.  This could be due to a permissions error.");
                }
