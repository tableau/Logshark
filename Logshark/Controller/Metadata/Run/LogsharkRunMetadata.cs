...
namespace Logshark.Controller.Metadata.Run
{
    ...
    public sealed class LogsharkRunMetadata
    {
        ...
        public string VersionLogparsers { get; set; }
        ...
        public LogsharkRunMetadata(LogsharkRequest request)
        {
            ...
            VersionLogparsers = typeof(ParserFactory).Assembly.GetName().Version.ToString();
        ...
        private ISet<string> GetExecutedPlugins(LogsharkRequest request)
        {
            ...
            {
                if (PluginLoader.IsPluginMatchingProductType(pluginType, request.RunContext.LogsetType))
                {
