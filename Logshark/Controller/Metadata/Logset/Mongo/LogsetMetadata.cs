...
namespace Logshark.Controller.Metadata.Logset.Mongo
{
    ...
    internal class LogsetMetadata
    {
        ...
        [BsonRequired]
        [BsonElement("processed_by_logparsers_version")]
        ...
        public LogsetMetadata(LogsharkRequest request)
        {
            ...
            LogsetType = request.RunContext.LogsetType.ToString();
            ...
            ParserVersion = typeof(ParserFactory).Assembly.GetName().Version.ToString();
        ...
        public bool IsHeartbeatExpired()
        {
            ...
            if (timeSinceLastHeartbeat.TotalSeconds >= LogsharkConstants.MONGO_PROCESSING_HEARTBEAT_EXPIRATION_TIME)
            {
                return true;
            }
            else
